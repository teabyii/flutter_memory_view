...
class _ImageListState extends State<ImageList>
  ...
  Widget listView() => ListView.builder(
        ...
        itemBuilder: (
          ...
          print('Start Network Load: [$idx] $imgUrl');
  ...
  void _jumpNewPage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => AnotherImageList()),
    );
  }
}

class AnotherImageList extends ImageList {}
